...
มาพร้อมระบบ Ai จับคู่งานกับธุระของคุณ ได้ที่นี่
          ...
          {/* For Company */}
          <div>
            <h3 className="font-bold text-lg mb-4 text-gray-900">การติดต่อ</h3>
            <ul className="space-y-2 text-sm">
              <li><Link href="https://gmail.com" className="text-gray-600 hover:text-green-500">Email ktcm02@ktcm.ac.th</Link></li>
              <li><Link href="https://line.me/R/ti/p/~icarejob.online" className="text-gray-600 hover:text-green-500">LineId icarejob.online</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-8 pt-8 border-t text-sm text-center text-gray-600">
          © Copyright {new Date().getFullYear()}  By Jittavee ICarejob.online 
        </div>
      </div>
    </footer>
  );
